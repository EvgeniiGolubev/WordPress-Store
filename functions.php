<?php
    ...
    function add_features() {
        add_theme_support( 'post-thumbnails', array( 'post' ) ); // Добавлена возможность добавлять миниатюры изображения в "записи" (post)
        ...
        add_image_size( 'adv_thumbnail', 100, 100, true ); // Регистрация миниатюры для header-advantages.php
    }
